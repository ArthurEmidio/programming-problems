...
int main()
{
    for (;;) {
        ...
        double circumradius = t.circumradius();
        double totArea = PI * (circumradius * circumradius);
        double sunflowersArea = totArea - tArea;
        
        double inradius = t.inradius();
        double rosesArea = PI * (inradius * inradius);
        
        double violetsArea = tArea - rosesArea;
        
        printf("%.4f %.4f %.4f\n", sunflowersArea, violetsArea, rosesArea);
    }
