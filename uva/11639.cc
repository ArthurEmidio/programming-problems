...
int main()
{
    ...
    while (n--) {
        ...
        double strongArea = hasIntersection ? inter.area() : 0;
        double weakArea = r1.area() + r2.area() - 2*strongArea;
        double unsecuredArea = 100*100 - (weakArea+strongArea);
        
        printf("Night %d: ", tc++);
        printf("%.0f ", strongArea);
        printf("%.0f ", weakArea);
        printf("%.0f\n", unsecuredArea);
    }
